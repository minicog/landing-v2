...
function linkify(inputText) {
    ...
    replacedText = replacedText.replace(replacePattern2, '$1<a href="http://$2" target="_blank">Read More</a>');
    replacePattern3 = /(([a-zA-Z0-9\-\_\.])+@[a-zA-Z\_]+?(\.[a-zA-Z]{2,6})+)/gim;
    replacedText = replacedText.replace(replacePattern3, '<a href="mailto:$1">$1</a>');
    return replacedText;
}

loadJSON('https://api.trello.com/1/boards/xGb1uTbb/cards', function (cards) {
